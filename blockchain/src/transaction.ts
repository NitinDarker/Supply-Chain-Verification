...
import { sha256, signData, verifySignature } from "./crypto.ts";
import { TxType } from "./types.ts";
import type { TransactionInput, TransactionDTO } from "./types.ts";
...
export class Transaction {
  ...
  public static fromJSON(obj: TransactionDTO): Transaction {
